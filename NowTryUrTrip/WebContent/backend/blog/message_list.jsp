...
<%
	...
	List<BlogMsgReportVO> list2 = blogMsgReportSvc.getAll();
...
<body class=" theme-blue">
	...
	<div class="navbar navbar-default" role="navigation">
		<div class="navbar-header">
			...
			<a href="index.html"> <span class="navbar-brand"> <span
					class="fa fa-paper-plane"></span> NowTryUrTrip
			</span>
			</a>
		</div>
			...
			<ul id="main-menu" class="nav navbar-nav navbar-right">
				<li class="dropdown hidden-xs"><a href="#"
					class="dropdown-toggle" data-toggle="dropdown"> <span
						...
						style="position: relative; top: 3px;"></span>${managerVO.mgrName},你好!<i
	...
	<div class="content">
		<!-- 麵包屑 -->
		<div class="header">
			<h1 class="page-title">留言檢舉管理</h1>
			<ul class="breadcrumb">
				<li><a href="index.html">首頁</a></li>
				<li class="active">留言檢舉管理</li>
			</ul>
		</div>
		<!-- 錯誤回報區 -->
		<div>
		...
		<hr>
			<table class="table">
				...
				<tbody>
					...
					<c:forEach var="blogMsgReportVO" items="${list2}">
						<tr align='center' valign='middle'>
							...
							<td><fmt:formatDate value="${blogMsgReportVO.rpTime}"
									pattern="yyyy/MM/dd HH:mm" /></td>
							<td>${typeMap.get(blogMsgReportVO.adminChecked)}</td>
		...
		<hr>
			<table class="table">
				...
				<tbody>
					...
					<c:forEach var="blogReplyReportVO" items="${list}">
						<tr align='center' valign='middle'>
							<td style="text-align: center;"><input type="checkbox" /></td>
							...
							<td><fmt:formatDate value="${blogReplyReportVO.rpTime}"
									pattern="yyyy/MM/dd HH:mm" /></td>
							<td>${typeMap.get(blogReplyReportVO.adminChecked)}</td>
		...
		<footer>
			...
			<p class="pull-right">
				A <a href="http://www.portnine.com/bootstrap-themes" target="_blank">something
					footer here</a> by <a href="http://www.portnine.com" target="_blank">something
					footer here</a>
			</p>
			<p>
				© something footer here <a href="http://www.portnine.com"
					target="_blank"> something footer here </a>
			</p>
		</footer>
	</div>
