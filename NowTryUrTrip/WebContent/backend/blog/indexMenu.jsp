...
<c:if test = "${loginManagerVO.mgrIdentity == 1}">
		...
		<li><a href="#" data-target=".legal-menu"
			class="nav-header collapsed" data-toggle="collapse"><i
				class="fa fa-fw fa-legal"></i> 日誌管理<i class="fa fa-collapse"></i></a></li>
...
<c:if test= "${loginManagerVO.mgrIdentity == 2 || loginManagerVO.mgrIdentity == 1}">
		...
		<li><a href="faq.html" class="nav-header collapsed"> <i
...
<!-- 			<li data-popover="true" data-placement="right"> -->
			<li>
				<a href="#" data-target=".trip-menu" class="nav-header collapsed" data-toggle="collapse">
					<i class="fa fa-fw fa-briefcase"></i> 部落格管理<i class="fa fa-collapse"></i>
				</a>
			</li>
			<li>
				<ul class="trip-menu nav nav-list collapse">
					<li class="active">
						<a href="<%=request.getContextPath() %>/backend/blog/article_list.jsp">
							<span class="fa fa-caret-right"></span>部落格文章檢舉處理
						</a>
					</li>
					<li>
						<a href="<%=request.getContextPath() %>/backend/blog/message_list.jsp">
							<span class="fa fa-caret-right"></span>部落格留言檢舉處理
						</a>
					</li>
				</ul>
			</li>
