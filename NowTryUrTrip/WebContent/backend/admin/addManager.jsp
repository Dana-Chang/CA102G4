			...
			<ul id="main-menu" class="nav navbar-nav navbar-right">
				<li class="dropdown hidden-xs"><a href="#"
					class="dropdown-toggle" data-toggle="dropdown"> <span
						...
						</span>${loginManagerVO.mgrName},你好!<i class="fa fa-caret-down"></i>
				</a>
		...
		<div class="main-content">
			...
			<div class="dialog">
				<div class="panel panel-default">
					<p class="panel-heading no-collapse">新增管理員帳號</p>
					<div class="panel-body">
						<form method="post" class="form-signin" role="form"
							action="<%=request.getContextPath()%>/Manager/mgr.do?action=inster">
							<div class="form-group">
								<label>姓名</label> <input name="mgrName" type="text" class="form-control span12"
									value="<%=(loginManagerVO != null) ? "吳永志" : loginManagerVO.getMgrName()%>" />
							</div>
							<div class="form-group">
								<label>帳號</label> <input name="mgrAccount" type="text" class="form-control span12"
									value="<%=(loginManagerVO != null) ? "yayaya" : loginManagerVO.getMgrAccount()%>" />
							</div>
							<div class="form-group">
								<label>密碼</label> <input name="mgrPsw" type="text" class="form-control span12"
									value="<%=(loginManagerVO != null) ? "123" : loginManagerVO.getMgrPsw()%>" />
							</div>
							<div class="form-group">
								<label>身分</label> 
									<select name="mgrIdentity" class="form-control span12">
									<option value="">請選擇</option>
									<option value="1">總管理員</option>
									<option value="2">代購管理員</option>
									<option value="3">行程規劃管理員</option>
								</select>
							</div>
							<div class="form-group">
								<button class="btn btn-primary pull-right" type="submit">送出新增</button>
