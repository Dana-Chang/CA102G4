						...
						<form method="post" class="form-signin" role="form"
							...
							<div class="form-group">
								<label>管理員編號:</label> <br>
									<a><%=managerVO.getMgrId()%></a>
							</div>
							<div class="form-group">
								<label>管理員姓名</label> <input name="mgrName" type="text" class="form-control span12"
									value="<%=managerVO.getMgrName()%>" />
							</div>
							<div class="form-group">
								<label>管理員帳號</label> <input name="mgrAccount" type="text" class="form-control span12"
									value="<%=managerVO.getMgrAccount()%>" />
							</div>
							<div class="form-group">
								<label>管理員密碼</label> <input name="mgrPsw" type="text" class="form-control span12"
									value="<%=managerVO.getMgrPsw()%>" />
							</div>
							<div class="form-group">
								<label>管理員身分</label> <input name="mgrIdentity" type="text" class="form-control span12"
									value="<%=managerVO.getMgrIdentity()%>" />
							</div>
							<div class="form-group">
								<label>是否停權</label> <input name="mgrStatus" type="text" class="form-control span12"
									value="<%=managerVO.getMgrStatus()%>" />
							</div>
							<div class="form-group">
								<input type="hidden" name="action" value="update">
								<input type="hidden" name="mgrId"  value="<%=managerVO.getMgrId()%>">
