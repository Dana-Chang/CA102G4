...
<%
BlogMsgReportVO blogMsgReportVO = (BlogMsgReportVO) request.getAttribute("blogMsgReportVO");
			...
			<table class="table">
				...
				<tbody>
						...
						<tr align='center' valign='middle'>
							...
							<td><fmt:formatDate value="${blogMsgReportVO.rpTime}" pattern="yyyy/MM/dd HH:mm" /></td>
							<td><input type="TEXT" name="adminChecked" size="1"	value="${blogMsgReportVO.adminChecked}" /></td>
							<td><input type="TEXT" name="noRpReason" size="45" value="${blogMsgReportVO.noRpReason}" /></td>
