	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-sm-12 col-md-6">
				<h1 class="header">
					文章列表 <a class="btn btn-primary addArticle"
						href="addBlogArticle.jsp">新增文章</a>
				</h1>
				<hr>
				...
				<c:forEach var="blogArticleVO" items="${list}"
					...
					<tr align='center' valign='middle'>
						...
						<br>
					<tr>
						<FORM id="form2" METHOD="post" ACTION="blogArticle.do">
							<input class="btn btn-default editbtn" type="submit" value="編輯">
						...
						<FORM METHOD="post" ACTION="blogArticle.do">
							<input class="btn btn-default editbtn" type="submit" value="刪除">
							<input type="hidden" name="articleNo"
								value="${blogArticleVO.articleNo}"> <input type="hidden"
