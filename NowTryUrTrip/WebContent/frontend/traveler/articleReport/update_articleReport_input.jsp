			...
			<table class="table">
				...
				<tbody>
						...
						<tr align='center' valign='middle'>
							...
							<td><fmt:formatDate value="${articleReportVO.rpTime}" pattern="yyyy/MM/dd HH:mm" /></td>
							<td><input type="TEXT" name="adminChecked" size="1"	value="${articleReportVO.adminChecked}" /></td>
							<td><input type="TEXT" name="noRpReason" size="45" value="${articleReportVO.noRpReason}" /></td>
