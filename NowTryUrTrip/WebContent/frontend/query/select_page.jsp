...
<body bgcolor='white'>
	...
	<ul>
		...
		<li>
			<FORM METHOD="post" ACTION="<%=request.getContextPath() %>/frontend/query/frontSpot.do">
				<b>輸入景點編號 (開始):</b> <input type="text" name="spotNo">
		...
		<li>
			<FORM METHOD="post" ACTION="<%=request.getContextPath() %>/frontend/query/frontSpot.do">
				...
				<input type="submit" value="送出"> <input type="hidden" name="action" value="getOne_For_Display">
			</FORM>
		</li>
	</ul>
