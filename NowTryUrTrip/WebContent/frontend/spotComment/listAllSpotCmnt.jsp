	...
	<table border='1' bordercolor='#CCCCFF' width='800'>
		...
		<c:forEach var="spotVO" items="${list}" begin="<%=pageIndex%>"
			...
			<tr align='center' valign='middle'>
				...
				<td><img src="<%=request.getContextPath() %>/frontend/query/DBImgReader.do?spotNo=${spotVO.spotNo }" width=250px></td>
				...
				<td>
					<FORM METHOD="post"
						ACTION="<%=request.getContextPath()%>/frontend/query/spot.do">
				...
				<td>
					<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/frontend/query/spot.do">
