...
%>
<jsp:useBean id="listTrips_ByCompositeQuery" scope="request" type="java.util.List" />
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-xs-12 col-sm-9"> 
				<!-- --------平台優選-------- -->
				<c:if test="${tripSvc.all.size()==0 }">
					<table class="table table-responsive" id="backendTrip" >
				...
				<!-- --------店家專區-------- -->
				<c:if test="${tripSvc.all.size()==0 }">
					<table class="table table-responsive" id="storeTrip">
				...
				<!-- --------所有行程-------- -->	
				<c:if test="${tripSvc.all.size()==0 }">
					<table class="table table-responsive" id="generalTrip">
